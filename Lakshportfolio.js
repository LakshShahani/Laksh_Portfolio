function setFavIco(favico) {
    ...
    if(isbrowserColorModeDark) {
        favico.href = "Laksh_Logo_White.ico";
    }else {
        favico.href = "Laksh_Logo_Black.ico";
    }
}
function setHomePageUrl() {
    let indexPageUrl = "http://127.0.0.1:5500/Lakshportfolio.html";
...
``
    ...
    function setColorMode(theme) {
        if(theme.checked) {
            ...
            $(".Laksh_Logo").attr("src", "Laksh_Logo_White.png");
            $("#education-img-graduation").attr("src", "graduateWhite.png");
            $("#education-img-hsc").attr("src", "hscWhite.png");
            $("#education-img-ssc").attr("src", "sscWhite.png");
            ...
            $(".Laksh_Logo").attr("src", "Laksh_logo_Black.png");
            $("#education-img-graduation").attr("src", "graduateDark.png");
            $("#education-img-hsc").attr("src", "hscDark.png");
            $("#education-img-ssc").attr("src", "sscDark.png");
            for(let i=0; i<themeSwitch.length; i++) {
